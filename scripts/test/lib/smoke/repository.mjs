...
export const blazorServerAppTemplateDirectory = path.join(repositoryRoot, 'tests', 'BlazorServerApp');
export const blazorWasmAppTemplateDirectory = path.join(repositoryRoot, 'tests', 'BlazorWasmApp');
